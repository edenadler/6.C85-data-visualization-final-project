...
<div>
    <div class="DuringMigration">
        ...
        <div class="ViolenceMigrationNarrative vis-container">
            ...
            <div class="source"><a href="https://www.jstor.org/stable/44861315" target="_blank">Schmidt, Buechler, 2017</a></div>
        </div> 

        <div class="vis-container">
          <div class="transition-text">
            <!-- <div>Migrants are esspecially susceptible to being exploited for their vulnerabilities.</div>  -->
          ...
          <div class="transition-text">
            ...
            <div class="source"><a href="https://www.migrationpolicy.org/sites/default/files/publications/mpi-wfp-mit_migration-motivations-costs_final.pdf" target="_blank">World Food Programme, MIT, Migration Policy Institute</a></div>
          </div>
